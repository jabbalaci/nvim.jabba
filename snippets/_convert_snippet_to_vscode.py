...
def process(fname: str) -> None:
    ...
    #
    print(
        "// DON'T EDIT THIS FILE MANUALLY! It's generated from `d.snippets`. Edit `d.snippets` instead."
    )
    print("// Location: ~/Dropbox/home/jabba/.config/nvim.ks/snippets/d.snippets")
